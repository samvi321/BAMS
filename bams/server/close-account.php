...
<div class="col-sm-2 bar pr-0">
    ...
    <?php
                ...
                ?>
<form class="form shadow p-4" action="../includes/delete-script.php" method="post">
    <div class="text-center login-header text-light"><h4>Delete an account</h4></div>
    <div class="p-4">
        ...
        <div class="form-group text-center">
            <button type="submit" class="lbtn btn px-4 m-2" name="delete">Delete</button>
        </div>
    </div>
</form>
    </div>
