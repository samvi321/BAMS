...
<div class="col-sm-2 bar pr-0">
    ...
    <div class="col-sm-10 text-center pt-4">
        <h3 class="text-left">Change Pin</h3>
...
<form class="form shadow p-4" action="../includes/change-security.php" method="post">
    <div class="text-center login-header text-light"><h4>Change Pin Number</h4></div>
    <div class="p-4">
        ...
        <div class="form-group border row mb-0">
            <label for="pin" class="col-sm-4 col-form-label" id=" info-label">New Account Pin</label>
            <div class="col-sm-8 text-left">
            <input type="pin" class="form-control m-2 w-50" id="pin" name="pin" maxlength="4" size="4" required>
            </div>
        </div>
        <div class="form-group border row mb-0">
            <label for="vpin" class="col-sm-4 col-form-label" id=" info-label">Confirm Account Pin</label>
            <div class="col-sm-8 text-left">
            <input type="pin" class="form-control m-2 w-50" id="vpin" name="vpin" maxlength="4" size="4" required>
            </div>
        </div>
        <div class="form-group text-center">
            <button type="submit" class="lbtn btn px-4 m-2" name="change-pin">Change Account PIN</button>
        </div>
    </div>
</form>
    </div>
